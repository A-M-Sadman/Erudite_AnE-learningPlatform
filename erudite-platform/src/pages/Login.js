  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      const demoCredentials = {
        ...
        data: { email: 'data@erudite.com', password: 'data123' },
        support: { email: 'support@erudite.com', password: 'support123' }
      };
      ...
      if (isLogin) {
        ...
        const isData = formData.email === demoCredentials.data.email && 
                       formData.password === demoCredentials.data.password;
        const isSupport = formData.email === demoCredentials.support.email && 
                         formData.password === demoCredentials.support.password;

        if (isAdmin || isInstructor || isStudent || isData || isSupport) {
          // Store user data
          const userData = {
            email: formData.email,
            name: isAdmin ? 'Admin User' : 
                  isInstructor ? 'Instructor User' : 
                  isData ? 'Data Specialist' : 
                  isSupport ? 'IT Support' :
                  'Student User',
            role: isAdmin ? 'admin' : 
        ...
        {isLogin && (
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div className="text-xs text-blue-700 space-y-1">
              <p>👨‍💼 Admin: admin@erudite.com / admin123</p>
              <p>👨‍🏫 Instructor: instructor@erudite.com / instructor123</p>
              <p>👨‍🎓 Student: student@erudite.com / student123</p>
              <p>📊 Data Specialist: data@erudite.com / data123</p>
              <p>🛠️ IT Support: support@erudite.com / support123</p>
            </div>
          </div>
        )}
      </div>
